...
export default function ShareButton({
    ...
    return (
        ...
        <button
                ...
                className={`flex items-center justify-center gap-2 rounded-full bg-black px-6 py-3 font-semibold text-white transition-colors hover:bg-gray-800 ${className}`}
            >
                    <svg
                        className='h-5 w-5'
                        fill='none'
